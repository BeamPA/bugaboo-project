    ...
    <div className="flex h-full w-full flex-col gap-6 py-8 pl-4 pr-0 sm:pl-8 lg:gap-10 lg:px-8 lg:py-10 xl:px-28 2xl:px-[144px]">
      ...
      <div className="relative" role="region" aria-roledescription="carousel">
        {canScrollLeft && (
          <button
            onClick={scrollLeft}
            className="absolute left-0 top-1/2 -translate-y-1/2 z-10 rounded-full bg-white p-2 shadow-md hover:bg-gray-100"
          >
        ...
        {canScrollRight && (
          <button
            onClick={scrollRight}
            className="absolute right-0 top-1/2 -translate-y-1/2 z-10 rounded-full bg-white p-2 shadow-md hover:bg-gray-100"
          >
              ...
              <div className="relative flex flex-col gap-3">
                <a href={item.href} target="_blank" rel="noopener noreferrer">
                  <div className="relative flex flex-col gap-3">
                    ...
                    <div>
                      <div className="font-semibold text-sm lg:text-base leading-4 lg:leading-5 line-clamp-2 text-text-primary-900">
                        {item.title}
                      </div>
                      <div className="font-normal text-2xs lg:text-sm leading-2 lg:leading-3 text-text-secondary-700">
                        {item.episodes}
                      </div>
                    </div>
                  </div>
