...
export default function DramaPage() {
  ...
  return (
    <div className="bg-gradient-to-b from-bg-gradient-top to-bg-gradient-bottom">
      <div className="flex flex-col py-8 px-4 sm:px-8 lg:px-16 xl:px-28 2xl:px-[144px] gap-8">
        <div className="flex items-center ">
          <h1 className="text-2xl text-black">ดรามาน้ำตาคลอ</h1>
          <a
            target="_self"
            className="flex items-center ml-2 gap-2 text-[#7811f1]"
            href="/drama/"
          >
      ...
      <div
        className="relative flex flex-col py-8 px-4 sm:px-8 lg:px-16 xl:px-28 2xl:px-[144px] gap-8"
        role="region"
                ...
                <a href={item.href} target="_blank" rel="noopener noreferrer">
                  <div className="relative flex flex-col gap-3">
                    ...
                    <div>
                      ...
                      <div className="font-semibold text-sm lg:text-base leading-4 lg:leading-5 line-clamp-2 text-black">
                        {item.title}
                      </div>
